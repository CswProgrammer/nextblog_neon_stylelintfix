...
export const ZustandDemo: FC = () => {
    ...
    return (
        <div className="tw-flex tw-flex-auto tw-flex-col tw-items-center tw-justify-center tw-overflow-auto">
            {/* 控制面板 - 添加滚动支持 */}
            <div className={clsx($styles.container, 'tw-w-full tw-max-w-[100rem] tw-overflow-x-auto')}>
                <div className="tw-flex tw-justify-between tw-min-w-max">
                    <ModeCtrol />
                    <ThemeCtrol />
                </div>
            </div>
